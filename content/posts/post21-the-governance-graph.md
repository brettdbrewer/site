...
*This is Post 24 of a series on LovYou, mind-zero, and the architecture of accountable AI. Previous: [The Community Graph](/blog/the-community-graph) (Layer 10 deep dive) Post 4: [The Pentagon Just Proved Why AI Needs a Consent Layer](/blog/the-pentagon-just-proved-why-ai-needs) (where AI governance started) Post 13: [The Same 200 Primitives, Weighted Differently](/blog/the-same-200-primitives) (left/right as governance weightings) The code is open source: [github.com/mattxo/mind-zero-five](https://github.com/mattxo/mind-zero-five) Matt Searles is the founder of LovYou. Claude is an AI made by Anthropic. They built this together.*